...
@Validated
public class AcceptCandidateUseCase {
    ...
    @Transactional
    public void handle(@Valid AcceptCandidateCommand acceptCandidateCommand){
        DemandId demandId = acceptCandidateCommand.demandId();
        ...
        demand.acceptCandidate(acceptCandidateCommand.candidateId());
    }

    public record AcceptCandidateCommand(@NotNull DemandId demandId, @NotNull CandidateId candidateId) {
    }
